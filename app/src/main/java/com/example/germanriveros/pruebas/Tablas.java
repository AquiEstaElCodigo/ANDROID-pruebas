...
/**
 * Created by germanriveros on 27-05-16.
 */
public class Tablas extends DataBaseManager
{

    public Tablas(Context context){ super(context); }
...
*/
    ...
    public static final String INSERTAR_LETRA_N="INSERT INTO " + TABLE_LETRA_N + " (" + CN_ESP + "," + CN_MAPU +")"
            ...
            ";";
/*
    public static final String INSERTAR_LETRA_ENYE="INSERT INTO " + TABLE_LETRA_ENYE + " (" + CN_ESP + "," + CN_MAPU +")"
            + " VALUES"+
            "('','' )," +
            "('','' )," +
