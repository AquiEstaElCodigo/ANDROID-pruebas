...
public class DataBaseManager
{
    ...
    //public static final String TABLE_LETRA_ENYE = "LETRA_ENYE";
...
*/
    ...
    public static final String CREATE_TABLE_Z = "CREATE TABLE IF NOT EXISTS " + TABLE_LETRA_Z + " ("
            ...
            + CN_MAPU + " TEXT NOT NULL);";
/*
    public static final String CREATE_TABLE_ENYE = "CREATE TABLE IF NOT EXISTS " + TABLE_LETRA_ENYE + " ("
            + CN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + CN_ESP + " TEXT NOT NULL,"
            + CN_MAPU + " TEXT NOT NULL);";
*/
...
/*
            case 'LL': return sqLiteDatabase.query(TABLE_LETRA_LL,columnas,null,null,null,null,null);
            break;
*/
